...
import { Options as BrowserSyncConfig } from 'laravel-mix/types/browsersync';
import * as ExtractTypes from 'laravel-mix/types/extract';
...
// @ts-ignore - May not be installed initially
import MixHelpers from 'laravel-mix/src/Mix';
...
declare global {
     ...
     **/
    var Mix: import('laravel-mix/src/Mix');
     ...
     * @deprecated This will go away in a future release
     **/
    var webpackConfig: import('laravel-mix/src/builder/WebpackConfig');
     ...
     * @deprecated This will go away in a future release
     **/
    var Config: ReturnType<typeof import('laravel-mix/src/config')>;
}
