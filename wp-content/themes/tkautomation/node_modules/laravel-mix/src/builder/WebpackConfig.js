...
let webpackPlugins = require('laravel-mix/src/builder/webpack-plugins');
let webpackDefaultConfig = require('laravel-mix/src/builder/webpack-default');

class WebpackConfig {
    /**
     * Create a new instance.
     *
     * @param {import("laravel-mix/src/Mix")} mix
     */
    constructor(mix) {
        this.mix = mix;
     ...
     */
    buildChunks() {
        this.webpackConfig = require('laravel-mix/src/builder/MergeWebpackConfig')(
            this.webpackConfig,
